document.addEventListener("DOMContentLoaded", () => {
  ...
  const translations = {
    pt: {
      ...
      project1Text: "Soluções tecnológicas, estrutura operacional e implementação de sistemas para negócios em crescimento.",
      project2Text: "Experiências criativas e digitais conectadas à música, marca e crescimento de audiência.",
      project3Text: "Projetos voltados para estratégia, mentalidade, estrutura e evolução de negócios.",
    ...
    en: {
      ...
      project1Text: "Technology solutions, operational structure, and systems implementation for growing businesses.",
      project2Text: "Creative and digital experiences connected to music, brand, and audience growth.",
      project3Text: "Projects focused on strategy, mindset, structure, and business evolution.",
